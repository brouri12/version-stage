...
class ResetPasswordController extends AbstractController
{
    ...
    {
        return $this->requestStack->getSession()->get('ResetPasswordPublicToken');
    }

    private function storeTokenInSession(string $token): void
    {
        $this->requestStack->getSession()->set('ResetPasswordPublicToken', $token);
    }

    private function getTokenObjectFromSession(): ?object
    {
        return $this->requestStack->getSession()->get('ResetPasswordToken');
    }

    private function setTokenObjectInSession(object $token): void
    {
        $this->requestStack->getSession()->set('ResetPasswordToken', $token);
    }

    private function cleanSessionAfterReset(): void
    {
        $this->requestStack->getSession()->remove('ResetPasswordPublicToken');
        $this->requestStack->getSession()->remove('ResetPasswordToken');
    }
} 